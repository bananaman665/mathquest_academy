        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Welcome to Mathlified (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;). We are committed to protecting your privacy and the privacy of children who use our educational app. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our mobile application and website.
            </p>
            <p className="text-gray-700 leading-relaxed">
              By using Mathlified, you agree to the collection and use of information in accordance with this policy.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Mathlified is designed for children and complies with the Children&apos;s Online Privacy Protection Act (COPPA). We do not knowingly collect personal information from children under 13 without parental consent.
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Mathlified uses the following third-party services:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Your information may be transferred to and maintained on servers located outside of your country. By using Mathlified, you consent to the transfer of your information to countries that may have different data protection laws than your country of residence.
            </p>
          </section>
