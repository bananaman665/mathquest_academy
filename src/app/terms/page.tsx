        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Welcome to Mathlified! These Terms of Service (&quot;Terms&quot;) govern your access to and use of the Mathlified mobile application and website (collectively, the &quot;Service&quot;). By accessing or using our Service, you agree to be bound by these Terms.
            </p>
            <p className="text-gray-700 leading-relaxed">
              If you do not agree to these Terms, please do not use our Service. If you are under 18 years of age, you must have your parent or guardian&apos;s permission to use Mathlified.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Mathlified is an educational platform that provides interactive math learning experiences for students. Our Service includes:
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              To use certain features of Mathlified, you must create an account. You agree to:
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              You agree to use Mathlified only for lawful purposes and in accordance with these Terms. You agree NOT to:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Mathlified includes virtual currency (gems) and virtual items (power-ups, shop items) that can be earned through gameplay or purchased with real money. You understand that:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Mathlified offers optional premium subscriptions with additional features. Subscriptions:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              The Service and its original content, features, and functionality are owned by Mathlified and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Mathlified is designed to supplement, not replace, traditional education. While we strive for accuracy in our educational content:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Your use of Mathlified is also governed by our <Link href="/privacy" className="text-blue-600 hover:underline">Privacy Policy</Link>. Please review it to understand how we collect, use, and protect your information, especially regarding children&apos;s privacy and COPPA compliance.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              To the maximum extent permitted by law, Mathlified shall not be liable for:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              You agree to indemnify and hold harmless Mathlified, its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from your use of the Service or violation of these Terms.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              These Terms, together with our Privacy Policy, constitute the entire agreement between you and Mathlified regarding the use of the Service and supersede any prior agreements.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              By using Mathlified, you acknowledge that you have read these Terms of Service and agree to be bound by them.
            </p>
          </section>
        </div>
      </div>
